function createAccountManager(deps) {
  const { crypto, getConfig, getTokenPool, saveConfig, logInfo, logDebug, logWarn, logError } = deps;
...
// quotaSummary remains available to account consumers through the manager.
  ...
  return { tokenFingerprint, normalizeEmail, accountIdentityKey, accountForToken, markAccountUsed, accountCheckInfo, normalizeMultimodalContent, extractQuota, mergeQuotaSources, removeTokenMetadata, resolveAndReconcileToken, reconcileAllTokenAccounts, checkIdleAccounts };
}
